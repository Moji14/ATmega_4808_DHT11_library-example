...
#include "avr/io.h"
//#include "C:\Program Files (x86)\Atmel\Studio\7.0\Packs\Atmel\ATmega_DFP\1.3.300\include\avr\iom4808.h"
...
{
	//i2c_start(&TWIE, i2c_lcd_ADDR, 0);//passing: register pointer, i2c lcd address, and 0 
	//i2c_write(&TWIE, i2c_lcd_status);
	//i2c_stop(&TWIE);
	//I2C_0_write1ByteRegister(i2c_lcd_ADDR,TWIE.MDATA,i2c_lcd_ADDR);
	//I2C_0_do_I2C_SEND_ADR_WRITE();
	I2C_0_write1ByteRegister(i2c_lcd_ADDR,&TWIE,i2c_lcd_status);
	//do_transfer(i2c_lcd_ADDR, i2c_lcd_status, 1);//do_transfer(slave_reg_adr, read_data, 2);
